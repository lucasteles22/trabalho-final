...
using SistemaAcademico.Business.WebApi.Providers;
using SistemaAcademico.Business.WebApi.Results;
...
namespace SistemaAcademico.Business.WebApi.Controllers
{
    ...
    public class AccountController : ApiController
    {
        ...
        public async Task<IHttpActionResult> Register(RegisterBindingModel model)
        {
            ...
            var user = new Student(1) { UserName = model.Email, Email = model.Email };
